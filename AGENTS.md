# AI Agent Reference for ha-aldi
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/aldi/__init__.py` |
| Coordinator | `custom_components/aldi/coordinator.py` |
| Config Flow | `custom_components/aldi/config_flow.py` |
| Sensor platform | `custom_components/aldi/sensor.py` |
